...
public class Persona {
    ...
    public Persona(String congnome, String nome, String codFisc, String dataDiNascita, String email)throws Exception{
        this();
    ...
    public Persona(Persona p1)throws Exception{
    ...
    public boolean verificaOmonimia(Persona p1)throws Exception{
