...
public class GestioneRaccolto {
    ...
    public void setRaccolto(Data data, float quintali) throws Exception{
        ...
        if(findData(data) != -1){
            throw new Exception("data gia esistente");
        }
        try{
...
/*
passo un array di dimensione fisica = numGiornate
Che sarà riempito by reference dal metodo che inserirà le giornate con un quantitativo di pome sopra un certo valore; questo metodo returna anche la dimLogica dell array riempito
*/
    ...
    private int findData(Data data)throws Exception{
        ...
        while(i < numGiornate && trovato == false){
